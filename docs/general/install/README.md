...
```hcl
module "alarm" {
    source = "github.com/pbs/terraform-cloudwatch-alarms-module-v2?ref=x.y.z"
}
```
...
```bash
git remote add -f cloudwatch-alarms git@github.com:pbs/terraform-cloudwatch-alarms-module-v2.git
